...
const lightEmeraldPalettes: Record<LightThemeVariant, ThemePalette> = {
  ...
  premium: {
    primary: '#166B51',
    primaryContainer: '#DDEAE5',
    secondary: '#8B6846',
    secondaryContainer: '#F1E4D4',
    tertiary: '#6D7D56',
    tertiaryContainer: '#E5ECDA',
    background: '#FAF7F2',
    surface: '#FFFFFF',
    surfaceVariant: '#F1E8DE',
    surfaceDisabled: '#E5DDD2',
    outline: '#B29C88',
    outlineVariant: '#DDD0C3',
    onPrimary: '#FFFFFF',
    onPrimaryContainer: '#163329',
    onSecondary: '#FFFFFF',
    onSecondaryContainer: '#4E3522',
    onTertiary: '#FFFFFF',
    onTertiaryContainer: '#333F21',
    onSurface: '#211A16',
  ...
  return {
    ...
    colors: {
      ...
      elevation: {
        ...
        level1: mode === 'dark' ? '#221B17' : '#F7EFE7',
        level2: mode === 'dark' ? '#281F1A' : '#FCF7F2',
