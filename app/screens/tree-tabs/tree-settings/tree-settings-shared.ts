...
export type CollaboratorsSectionProps = {
  ...
  role: SharedTabProps['role'];
  canManageCollaborators: SharedTabProps['canEdit'];
  isOwner: SharedTabProps['isOwner'];
  userId: SharedTabProps['userId'];
  mutating: SharedTabProps['mutating'];
...
export type MergesSectionProps = {
  ...
  onCreateMergeRequest: SharedTabProps['onCreateMergeRequest'];
  onSendMergeInvite: SharedTabProps['onSendMergeInvite'];
  onRespondToMergeInvite: SharedTabProps['onRespondToMergeInvite'];
  onRequestTreeAccess: SharedTabProps['onRequestTreeAccess'];
  onRequestTreeAccessByIdentifier: SharedTabProps['onRequestTreeAccessByIdentifier'];
  onSearchDiscoverableTrees: SharedTabProps['onSearchDiscoverableTrees'];
